...
const SignUp = props => {
  ...
  const handleSignUp = event => {
    ...
    history.push('/');
    //this is where we would take 'this.state.values[someValue]` and create a POST request with something like axios to send the signUp information to whatever our signup route would be
  };
